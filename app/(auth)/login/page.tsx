    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0f0f0f" }}>
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm" style={{ color: "#888" }}>Sign in to TubeWatch</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 rounded-lg text-white text-sm outline-none focus:ring-1 transition-all"
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-sm" style={{ color: "#888" }}>Password</label>
              <Link href="/forgot-password" className="text-xs hover:underline" style={{ color: "#00ff87" }}>
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <p className="text-center text-sm mt-6" style={{ color: "#555" }}>
          ...
          <Link href="/signup" className="hover:underline" style={{ color: "#00ff87" }}>
            Sign up free
          </Link>
        </p>
      </div>
