    ...
    <div className="p-4 md:p-8 max-w-6xl" style={{ color: "#fff" }}>
      ...
      <div className="flex items-center gap-4 mb-6 flex-wrap">
        <div className="flex items-center gap-1">
          <span style={{ fontSize: 12, color: "#555", marginRight: 4 }}>Max subs:</span>
        ...
        <div className="flex items-center gap-1">
          <span style={{ fontSize: 12, color: "#555", marginRight: 4 }}>Min score:</span>
          ...
          >
            {[
              ...
              >
                ...
                <div className="p-3">
                  <p className="font-medium mb-2 leading-snug" style={{ fontSize: 14, color: "#fff" }}>{card.title}</p>
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: "#2a2a2a", color: "#888" }}>
                      {card.channel[0]}
                    </div>
                    <span style={{ fontSize: 12, color: "#888" }}>{card.channel}</span>
                    <span style={{ fontSize: 12, color: "#555", marginLeft: "auto" }}>{card.subs} subs</span>
                  </div>
                  <div className="flex items-center gap-3 mb-3" style={{ fontSize: 12, color: "#555" }}>
                    <span>Jun 27, 2026</span>
                    <span style={{ marginLeft: "auto" }}>{card.views} views</span>
                  </div>
                  <div className="w-full py-1.5 rounded-lg text-xs font-medium text-center" style={{ background: "#1a1a1a", color: "#ccc", border: "1px solid #2a2a2a" }}>
                    Track Channel
                  </div>
                </div>
              </div>
                    ...
                    <button
                      ...
                      style={
                        tracked.has(ch.youtube_channel_id)
                          ...
                          ? { background: "#1a1a1a", color: "#555", border: "1px solid #2a2a2a", cursor: "wait" }
                          : { background: "#1a1a1a", color: "#ccc", border: "1px solid #2a2a2a", cursor: "pointer" }
                      }
                    >
                      {tracked.has(ch.youtube_channel_id)
                        ? "✓ Tracked"
